...
def add_img_names_to_boxes(names:list,
...
def divide_bb_file_detected(bb_file_detected: list[list[list[float | int]]]) -> tuple[
    list[list[list[float | int]]], list[list[list[float | int]]]]:
